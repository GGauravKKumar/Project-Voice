...
DIRECTORIES = {
    ...
    "IMAGES": [".jpeg", ".jpg", ".gif", ".bmp", ".png", "svg", ".heif", ".psd"],
    "VIDEOS": [".avi", ".flv", ".wmv", ".mov", ".mp4", ".webm", ".vob", ".mng", ".mpg", ".mpeg", ".3gp", ".mkv"],
    "DOCUMENTS": [".oxps", ".epub", ".pages", ".docx", ".doc", ".xps", ".dotx", ".docm", ".dox",
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            Alarm_Time=input("set an alarm of")
            Alarm_Time=Alarm_Time.replace("set an alarm of ", "")
            ...
            ctypes.windll.user32.SystemParametersInfoW(20, 0, "C:\\Users\\gaura\\OneDrive\\Minor Project\\Voice\\back.jpg" , 0)
            ...
            state=query.replace("rain in " ,"")
            driver.get("https://www.google.com/search?q=rain+in+"+state+"&oq=rain+in+delhi&aqs=chrome..69i57j69i60.2518j0j7&sourceid=chrome&ie=UTF-8")
            ratings = driver.find_element_by_class_name('wob_t').text
            status = driver.find_element_by_id('wob_dcp').text
            print("Weather ", status)
            print("Current Temperature ",ratings,"Degree Celcius")
